...
* [ ] Dashboard screen layout is completed.
...
* [ ] **[Functional - TUI]:** Modal forms submit validation data correctly.
* [ ] **[Verification]:** Pilot script tests in `tests/test_tui.py::test_transaction_entry_modal` simulate field editing.
