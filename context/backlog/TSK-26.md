...
* [x] Deviation use case complete (TSK-17 complete).
...
* [x] **[Functional - Cmd]:** Renders color-coded budget deviation table.
* [x] **[Verification]:** Tests run under `pytest tests/test_cli.py::test_report_generation` matching ANSI regex values.
