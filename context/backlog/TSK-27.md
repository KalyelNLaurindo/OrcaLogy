...
* [x] Textual package is configured (TSK-04 complete).
...
* [x] **[Functional - TUI]:** App initializes screen grids and listens to global shortcuts.
* [x] **[Verification]:** Runs tests in `tests/test_tui.py::test_tui_initialization` verifying component instances.
